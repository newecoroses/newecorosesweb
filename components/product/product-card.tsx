...
export default function ProductCard({ product, index = 0 }: { product: Product; index?: number }) {
    ...
    const whatsappMsg = `Hi! I'm interested in inquiring about ${product.name}. Could you please share more details?`;
    ...
    return (
        ...
        >
            ...
            <div className="p-3 sm:p-3.5 flex flex-col flex-grow justify-between bg-white">
                ...
                {/* Aesthetic Action Bar: WhatsApp Enquire + Add to Cart */}
                <div className="flex items-center gap-1.5 pt-2 border-t border-gray-100 mt-1.5">
                    ...
                    <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1 py-1.5 px-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200/60 transition-all duration-300 text-[11px] font-semibold active:scale-95 group/wa"
                        title="Enquire on WhatsApp"
                        aria-label="Enquire on WhatsApp"
                    >
                        <svg className="w-3.5 h-3.5 fill-emerald-600 group-hover/wa:scale-110 transition-transform flex-shrink-0" viewBox="0 0 24 24">
