...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#bfa81f] text-white relative overflow-hidden" style={{ backgroundColor: '#bfa81f' }}>

            {/* ═══ GIANT LUXURY BRAND STATEMENT BANNER ═══ */}
            <div className="w-full max-w-full bg-[#bfa81f] py-8 sm:py-12 md:py-16 border-b border-white/20 relative overflow-hidden select-none group">
                <div className="w-full max-w-full overflow-hidden px-2 text-center relative z-10 flex items-center justify-center">
                    <h2
                        className="font-montserrat text-[6.2vw] min-[400px]:text-[6.8vw] sm:text-[7.5vw] md:text-[8vw] lg:text-[8.5vw] font-black uppercase tracking-[0.04em] min-[400px]:tracking-[0.06em] sm:tracking-[0.14em] md:tracking-[0.18em] leading-none transition-all duration-500 cursor-default select-none whitespace-nowrap max-w-full drop-shadow-sm"
                        style={{
                ...
                <button
                    type="button"
                    onClick={scrollToTop}
                    className="absolute bottom-3 sm:bottom-5 right-3 sm:right-6 z-20 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/20 text-white border border-white/30 hover:bg-white hover:text-[#bfa81f] transition-all duration-300 flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 cursor-pointer group/top"
                    title="Back to Top"
                    aria-label="Scroll back to top"
                >
                    <ChevronUp size={18} className="group-hover/top:-translate-y-0.5 transition-transform" />
                </button>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-4">
                        <Link href="/" className="inline-flex items-center gap-3 group" aria-label="New Eco Roses — Home">
                            ...
                            />
                            <span className="font-serif text-base font-extrabold tracking-[0.08em] text-white group-hover:text-white/80 transition-colors">
                                NEW ECO ROSES
                            </span>
                        </Link>
                        ...
                        <div className="space-y-3 pt-2">
                            <div className="flex items-center gap-3">
                                <a
                                    ...
                                    className="w-10 h-10 rounded-xl bg-white/15 hover:bg-white/25 border border-white/20 flex items-center justify-center transition-all duration-300 group shadow-sm"
                        ...
                        <ul className="space-y-2.5">
                            {[
                                ...
                                <li key={link.href}>
                                    <Link
                                        href={link.href}
                                        className="text-xs md:text-sm text-white/85 hover:text-white transition-colors duration-300 font-light inline-block hover:translate-x-1 transform"
                                    >
                                        {link.label}
                                    </Link>
                                </li>
                    ...
                    <div className="lg:col-span-4 space-y-3.5">
                        ...
                        <div className="space-y-2 pt-1">
                            <a
                                ...
                                className="flex items-center gap-2 text-xs text-white hover:text-white/80 bg-white/10 hover:bg-white/20 px-3 py-2 rounded-xl border border-white/15 transition-all group"
            ...
            <div className="border-t border-white/15 bg-black/10">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex flex-col md:flex-row justify-between items-center gap-3 text-center md:text-left text-white">
            ...
            <div className="border-t border-white/10 bg-black/20 py-3">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-3 text-center sm:text-left">
                    ...
                    {/* Premium Developer Trigger Button — Clean Rectangle with rounded corners & White Text */}
                    <button
                        type="button"
                        onClick={() => setIsDevModalOpen(true)}
                        className="group relative inline-flex items-center gap-2 rounded-lg px-2.5 py-1 bg-black/25 hover:bg-black/40 border border-white/20 hover:border-white/40 transition-all duration-300 scale-90 sm:scale-85 origin-center sm:origin-right shadow-xs hover:scale-[0.93] sm:hover:scale-[0.88] active:scale-85 cursor-pointer"
                        aria-label="View developer profile"
                    >
                        {/* Icon box */}
                        <span className="w-4.5 h-4.5 rounded-md bg-white/10 border border-white/20 group-hover:border-white/40 group-hover:bg-white/15 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                            <svg className="w-2.5 h-2.5 text-white/80 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span className="flex flex-col items-start leading-none text-left">
                            <span className="text-[7.5px] uppercase tracking-[0.18em] text-white/50 group-hover:text-white/70 font-medium transition-colors">Crafted by</span>
                            <span className="text-[10px] font-bold text-white tracking-wide mt-0.5">Aditya Choudhury</span>
                        </span>

                        {/* Arrow */}
                        <svg className="w-2.5 h-2.5 text-white/40 group-hover:text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 ml-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
